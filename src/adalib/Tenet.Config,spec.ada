...
package Tenet.Config is
   ...
   type String_Configuration_Parameter  is limited private;
   type Boolean_Configuration_Parameter is limited private;
   type Integer_Configuration_Parameter is limited private;
   type Float_Configuration_Parameter   is limited private;
   type Date_Configuration_Parameter    is limited private;
   -- etc.

   function New_String_Configuration_Parameter  (File:    access Configuration_File;
                                                 Name:    in     Wide_String;
                                                 Default: in     Wide_String := "") return String_Configuration_Parameter;

   function New_Boolean_Configuration_Parameter (File:    access Configuration_File;
                                                 Name:    in     Wide_String;
                                                 Default: in     Boolean := False) return Boolean_Configuration_Parameter;

   function New_Integer_Configuration_Parameter (File:    access Configuration_File;
                                                 Name:    in     Wide_String;
                                                 Default: in     Integer := 0) return Integer_Configuration_Parameter;

   function New_Float_Configuration_Parameter   (File:    access Configuration_File;
                                                 Name:    in     Wide_String;
                                                 Default: in     Float := 0.0) return Float_Configuration_Parameter;

   function New_Date_Configuration_Parameter    (File:    access Configuration_File;
                                                 Name:    in     Wide_String;
                                                 Default: in     Ada.Calendar.Time := Ada.Calendar.Clock) return Date_Configuration_Parameter;
   ...
   function Value (Parameter: in Date_Configuration_Parameter)    return Ada.Calendar.Time;
   -- etc.
...
private
   ...
   type Configuration_File_Access is access all Configuration_File;



   type Configuration_Parameter_Common (Name_Length: Natural) is limited private with
      record
         File: Configuration_File_Access;
         Name: Wide_String(1..Name_Length);
      end record;


   type String_Configuration_Parameter (Name_Length: Natural) is limited private with
      record
         Value:  Wide_Unbounded_String;
         Common: Configuration_Parameter_Common(Name_Length);
      end record;
