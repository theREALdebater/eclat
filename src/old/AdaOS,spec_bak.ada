...
---------------------------------------------------------------------------
-- This package is the root of the entire AdaOS hierarchy.
...
-- This library unit ("AdaOS") forms the basis of the entire hierarchy of
-- Ada library units associated with the AdaOS operating system.
