...
function Directory_Path_Separator (Compartment: in Program_Compartment) return Path_String is ("/");



function Self_Directory_Alias (Compartment: in Program_Compartment) return Path_String is (".");
function Super_Directory_Alias (Compartment: in Program_Compartment) return Path_String is ("..");
function Home_Directory_Alias (Compartment: in Program_Compartment) return Path_String is ("~"); -- first node only
function Root_Directory_Alias (Compartment: in Program_Compartment) return Path_String is (""); -- first node only
